...
if(qualification != "" && board != "" && percentage != "" && year.length == 4 && percentage <= 100 && percentage >= 0) 
document.getElementById("edutable").innerHTML +=`<tr> <td>${qualification}</td> <td>${board}</td> <td>${percentage}</td> <td>${year}</td> </tr>`;
else
